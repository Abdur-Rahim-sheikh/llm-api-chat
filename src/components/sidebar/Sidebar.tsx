...
export function Sidebar({
  ...
  const [costTab, setCostTab] = useState<Provider>("openai");
      ...
      <div className="px-4 py-4 border-b border-zinc-800/60">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg bg-teal-500 flex items-center justify-center">
            <svg viewBox="0 0 24 24" className="w-4 h-4 text-zinc-950" fill="currentColor">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
            </svg>
          </div>
          <span className="font-bold text-zinc-100 text-sm tracking-tight">LLM Chat</span>
        </div>
      </div>
      ...
      <div className="px-3 pt-3">
        ...
        >
          <span className={cn(
            ...
            settings.active_provider === "openai" ? "bg-emerald-400" : "bg-blue-400"
          )} />
